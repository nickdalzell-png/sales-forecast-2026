...
with t1:
    ...
    st.subheader("Strong Performances")
    ca, cb, cc, cd = st.columns(4)
    with ca: st.metric("Q1 Regional", "Over ✅", "+18.8%")
    with cb: st.metric("Q1 CDN", "Over ✅", "+29.0%")
    with cc: st.metric("Q1 Total", "Over ✅", "+18.8%")
