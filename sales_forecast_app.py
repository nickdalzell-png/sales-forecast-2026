...
# =============================================
# QUARTER-BY-QUARTER YoY COMPARISON (split to avoid truncation)
# =============================================
yoy_regions = ["Regional Team"]*4 + ["CDN"]*2 + ["Chicago SF"]*4 + ["Malls"]*4 + ["NYC"]*4 + ["Boston"]*4
yoy_periods = ["Q1","Q2","Q3","Q4"] + ["H1","H2"] + ["Q1","Q2","Q3","Q4"]*4
